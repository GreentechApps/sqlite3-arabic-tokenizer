...
compile-macos:
	gcc -fPIC -dynamiclib -I generate generate/sqlite3-arabic-tokenizer.c -o dist/sqlite3-arabic-tokenizer.dylib

compile-macos-x86:
	mkdir -p dist/x86
	gcc -fPIC -dynamiclib -I generate src/sqlite3-arabic-tokenizer.c -o dist/x86/sqlite3-arabic-tokenizer.dylib -target x86_64-apple-macos10.12
